...
(* CORE_GENERATION_INFO="pic_detec,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a200t-fbg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=13.845000,HLS_SYN_LAT=15346665,HLS_SYN_TPT=none,HLS_SYN_MEM=171,HLS_SYN_DSP=33,HLS_SYN_FF=24042,HLS_SYN_LUT=45833,HLS_VERSION=2019_2}" *)
...
wire    grp_markov_fu_293_ap_ready;
wire    grp_markov_fu_293_ap_done;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state7;
reg    ap_enable_reg_pp0_iter1;
reg    ap_enable_reg_pp0_iter2;
wire    grp_markov_fu_293_ap_start;
wire    grp_markov_fu_293_ap_idle;
wire   [13:0] grp_markov_fu_293_img_BDCT_address0;
wire    grp_markov_fu_293_img_BDCT_ce0;
wire   [13:0] grp_markov_fu_293_img_BDCT_address1;
wire    grp_markov_fu_293_img_BDCT_ce1;
wire    grp_markov_fu_293_img_BDCT_we1;
wire   [31:0] grp_markov_fu_293_img_BDCT_d1;
wire   [7:0] grp_markov_fu_293_p_address0;
wire    grp_markov_fu_293_p_ce0;
wire    grp_markov_fu_293_p_we0;
wire   [31:0] grp_markov_fu_293_p_d0;
wire    grp_BDCT_fu_313_ap_start;
wire    grp_BDCT_fu_313_ap_done;
wire    grp_BDCT_fu_313_ap_idle;
wire    grp_BDCT_fu_313_ap_ready;
wire   [13:0] grp_BDCT_fu_313_image_in_out_address0;
wire    grp_BDCT_fu_313_image_in_out_ce0;
wire    grp_BDCT_fu_313_image_in_out_we0;
wire   [31:0] grp_BDCT_fu_313_image_in_out_d0;
...
reg   [7:0] j_0_reg_271;
reg    grp_markov_fu_293_ap_start_reg;
wire    ap_CS_fsm_state5;
reg    grp_BDCT_fu_313_ap_start_reg;
...
#0 grp_markov_fu_293_ap_start_reg = 1'b0;
#0 grp_BDCT_fu_313_ap_start_reg = 1'b0;
...
image_r_U(
    ...
    .d0(image_r_d0),
    .q0(image_r_q0),
    .address1(grp_markov_fu_293_img_BDCT_address1),
    .ce1(image_r_ce1),
    .we1(image_r_we1),
    .d1(grp_markov_fu_293_img_BDCT_d1),
    .q1(image_r_q1)
);
...
p_U(
    ...
    .ce0(p_ce0),
    .we0(p_we0),
    .d0(grp_markov_fu_293_p_d0),
    .q0(p_q0)
);

markov grp_markov_fu_293(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(grp_markov_fu_293_ap_start),
    .ap_done(grp_markov_fu_293_ap_done),
    .ap_idle(grp_markov_fu_293_ap_idle),
    .ap_ready(grp_markov_fu_293_ap_ready),
    .img_BDCT_address0(grp_markov_fu_293_img_BDCT_address0),
    .img_BDCT_ce0(grp_markov_fu_293_img_BDCT_ce0),
    .img_BDCT_q0(image_r_q0),
    .img_BDCT_address1(grp_markov_fu_293_img_BDCT_address1),
    .img_BDCT_ce1(grp_markov_fu_293_img_BDCT_ce1),
    .img_BDCT_we1(grp_markov_fu_293_img_BDCT_we1),
    .img_BDCT_d1(grp_markov_fu_293_img_BDCT_d1),
    .img_BDCT_q1(image_r_q1),
    .p_address0(grp_markov_fu_293_p_address0),
    .p_ce0(grp_markov_fu_293_p_ce0),
    .p_we0(grp_markov_fu_293_p_we0),
    .p_d0(grp_markov_fu_293_p_d0)
);

BDCT grp_BDCT_fu_313(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(grp_BDCT_fu_313_ap_start),
    .ap_done(grp_BDCT_fu_313_ap_done),
    .ap_idle(grp_BDCT_fu_313_ap_idle),
    .ap_ready(grp_BDCT_fu_313_ap_ready),
    .image_in_out_address0(grp_BDCT_fu_313_image_in_out_address0),
    .image_in_out_ce0(grp_BDCT_fu_313_image_in_out_ce0),
    .image_in_out_we0(grp_BDCT_fu_313_image_in_out_we0),
    .image_in_out_d0(grp_BDCT_fu_313_image_in_out_d0),
...
pic_detec_sptohp_Gfk #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 32 ),
    .dout_WIDTH( 16 ))
pic_detec_sptohp_Gfk_U104(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .din0(p_q0),
    .ce(grp_fu_388_ce),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state7) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state6) & (grp_markov_fu_293_ap_done == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_BDCT_fu_313_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln61_fu_410_p2 == 1'd1))) begin
            grp_BDCT_fu_313_ap_start_reg <= 1'b1;
        end else if ((grp_BDCT_fu_313_ap_ready == 1'b1)) begin
            grp_BDCT_fu_313_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_markov_fu_293_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state5)) begin
            grp_markov_fu_293_ap_start_reg <= 1'b1;
        end else if ((grp_markov_fu_293_ap_ready == 1'b1)) begin
            grp_markov_fu_293_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        ...
        image_r_address0 = grp_BDCT_fu_313_image_in_out_address0;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        image_r_address0 = grp_markov_fu_293_img_BDCT_address0;
    end else begin
        image_r_address0 = 'bx;
    end
end
...
always @ (*) begin
    if ((~((data_in_TVALID_int == 1'b0) & (icmp_ln63_fu_434_p2 == 1'd0)) & (1'b1 == ap_CS_fsm_state3))) begin
        ...
        image_r_ce0 = grp_BDCT_fu_313_image_in_out_ce0;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        image_r_ce0 = grp_markov_fu_293_img_BDCT_ce0;
    end else begin
        image_r_ce0 = 1'b0;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        image_r_ce1 = grp_markov_fu_293_img_BDCT_ce1;
    end else begin
        image_r_ce1 = 1'b0;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        ...
        image_r_d0 = grp_BDCT_fu_313_image_in_out_d0;
    end else begin
        image_r_d0 = 'bx;
    end
end
...
always @ (*) begin
    if ((~((data_in_TVALID_int == 1'b0) & (icmp_ln63_fu_434_p2 == 1'd0)) & (1'b1 == ap_CS_fsm_state3) & (icmp_ln63_fu_434_p2 == 1'd0))) begin
        ...
        image_r_we0 = grp_BDCT_fu_313_image_in_out_we0;
    end else begin
        image_r_we0 = 1'b0;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        image_r_we1 = grp_markov_fu_293_img_BDCT_we1;
    end else begin
        image_r_we1 = 1'b0;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state4 : begin
            if (((grp_BDCT_fu_313_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state4))) begin
        ...
        ap_ST_fsm_state6 : begin
            if (((1'b1 == ap_CS_fsm_state6) & (grp_markov_fu_293_ap_done == 1'b1))) begin
...
assign grp_BDCT_fu_313_ap_start = grp_BDCT_fu_313_ap_start_reg;
...
assign grp_markov_fu_293_ap_start = grp_markov_fu_293_ap_start_reg;
