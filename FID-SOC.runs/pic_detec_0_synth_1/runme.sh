...
HD_PWD='D:/wulian/DD/Image_FD-SOC/KWS-SOC.runs/pic_detec_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pic_detec_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pic_detec_0.tcl
